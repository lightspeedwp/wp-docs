...
> **Source:** https://www.atlassian.com/agile/scrum/backlogs

## TL;DR (LightSpeed)
Maintain a single ordered backlog; groom weekly; ensure each top item has ACs and links to designs/PRDs.
