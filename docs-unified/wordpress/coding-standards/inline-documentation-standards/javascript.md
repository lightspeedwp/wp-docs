...
If a Backbone class does not have an initialise function it should be documented by using `@inheritDoc` as follows:
...
| `@license`     | [todo] Document the software licence that applies to this code.                              |
