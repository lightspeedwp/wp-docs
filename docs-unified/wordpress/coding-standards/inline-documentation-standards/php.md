...
- Changing default/expected behaviours.
...
| **`@param`**      | datatype $variable description                              | Function/method parameter of the format: parameter type, variable name, description, default behaviour. For boolean and integer types, use `bool` and `int`, respectively.                                                                      |
