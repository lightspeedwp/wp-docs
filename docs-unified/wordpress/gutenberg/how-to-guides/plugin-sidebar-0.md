...
### Step 4: Initialise the input control
...
We want to initialise the value in the `MetaBlockField` component with the value of `sidebar_plugin_meta_block_field`, and keep it updated when that value changes.
