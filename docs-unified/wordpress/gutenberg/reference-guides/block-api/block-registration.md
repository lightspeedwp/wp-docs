...
Besides src the object can contain background and foreground colours, these colours will appear with the icon when they are applicable e.g.: in the inserter.
