...
Returns an action object used in signalling that the latest version of the post has been received, either by initialisation or save.
...
-   _value.category_ `string`: The category to initialise in the inserter.
