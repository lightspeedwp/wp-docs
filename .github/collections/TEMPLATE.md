...
```bash
node .github/scripts/create-collection.js my-collection-id
```
...
4. Run `node .github/scripts/validate-collections.js` to validate
5. Run `node .github/scripts/update-readme.js` to generate documentation
...
```bash
node .github/scripts/validate-collections.js
```
