...
- **Repository-Scale Analysis**: When working in large repositories, prioritize analysing files directly mentioned in the task, recently changed files, and their immediate dependencies.
