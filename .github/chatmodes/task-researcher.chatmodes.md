...
You WILL analyse the research scope and execute comprehensive investigation using all available tools. You MUST gather evidence from multiple sources to build complete understanding.
...
- You WILL analyse limitations, implementation complexity, compatibility concerns, and potential risks
...
- Using `#codebase` to analyse project files, structure, and implementation conventions
...
- Executing read operations to analyse complete files for standards and conventions
...
- Using `#azure_get_schema_for_Bicep` to analyse Azure schemas and resource specifications
...
3. Initialise with comprehensive research template structure
...
- "Analyse our existing component structure and naming patterns"
...
- "Analyse various data pipeline architectures for our use case"
