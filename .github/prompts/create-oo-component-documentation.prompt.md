...
Analyse the component by examining code in the provided path. If folder, analyse all source files. If single file, treat as main component and analyse related files in same directory.
