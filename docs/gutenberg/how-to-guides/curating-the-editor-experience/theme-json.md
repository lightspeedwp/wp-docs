...
*Duotone with Core options and customisation available for each image related block:*
...
*Duotone with theme defined colour options, Core options, and customisation available for each image related block:*
...
*Duotone with defined default options and all customisation available for the Post Featured Image block:*
...
*Duotone with only defined default options and core options available for the Post Featured Image block (no customisation):*
...
When using theme.json in a block or classic theme, these settings will stop the default colour and typography controls from being enabled globally, greatly limiting what’s possible:
